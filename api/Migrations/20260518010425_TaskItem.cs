        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "text", nullable: false, defaultValue: "A faire"),
                    Priority = table.Column<string>(type: "text", nullable: false, defaultValue: "Moyenne"),
                    Difficulty = table.Column<string>(type: "text", nullable: false, defaultValue: "SENIOR"),
